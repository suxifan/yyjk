package com.cictec.yyjk.linenet;
...
public class Generator {
	...
	private static GeneratorEntity getGeneratorEntity() {
		...
		entity.setBase_package("com.cictec.yyjk.linenet");// 生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
	...
	public static void main(String[] args) {
		...
		GeneratorCode.genCodeByCustomModelName("net_xml_dea_base_config", "NetXmlDeaBaseConfig");
