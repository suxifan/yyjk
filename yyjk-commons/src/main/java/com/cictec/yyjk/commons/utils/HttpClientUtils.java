 ...
 * @see 而在X509TrustManager实例中,若证书无效,那么TrustManager在它的checkXXX()
 *      方法中将抛出CertificateException
...
//			System.out
//					.println("HTTP应答完整报文=[" + respStatusLine + "\r\n" + respHeaderMsg + "\r\n\r\n" + respBodyMsg + "]");
//			System.out.println(
//					"-------------------------------------------------------------------------------------------");
	...
	public static String sendJSONPostRequest(String reqURL, String reqData, String encodeCharset) {
		String reseContent = "通信失败";
		HttpClient httpClient = new DefaultHttpClient();
		httpClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 10000);
		httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, 20000);
	...
	public static String sendPostRequest(String reqURL, Map reqData, String encodeCharset) {
		String reseContent = "通信失败";
		HttpClient httpClient = new DefaultHttpClient();
		httpClient.getParams().setParameter(CoreConnectionPNames.CONNECTION_TIMEOUT, 10000);
		httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, 20000);
		...
		try {
			...
			// encodeCharset));
			setParams(reqData, httpPost, encodeCharset);
			HttpResponse response = httpClient.execute(httpPost);
			HttpEntity entity = response.getEntity();
			if (null != entity) {
				reseContent = EntityUtils.toString(entity, ContentType.getOrDefault(entity).getCharset());
	...
	private static void setParams(Map<String, String> params, HttpPost httpPost, String encodeCharset)
	...
	public static void main(String[] args) {
		...
		System.out.println(HttpClientUtils
				.sendPostSSLRequest("https://123.125.97.66:8085/pay/servlet/CreditPayReqServlte", params, "UTF-8"));
	}
}