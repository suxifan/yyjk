...
public class MybatisConfigurer {
	...
	public static final String MODEL_PACKAGE = "com.cictec.yyjk.**.entity";// Model所在包
	public static final String MAPPER_PACKAGE = "com.cictec.yyjk.**.mapper";// Mapper所在包
...
//        factory.setMapperLocations(resolver.getResources("classpath:mapper/**/*.xml"));
        ...
        SqlSession session = factory.getObject().openSession();
        mapperHandler(session);
        
        return factory.getObject();
    }
    
    private void mapperHandler(SqlSession session){
