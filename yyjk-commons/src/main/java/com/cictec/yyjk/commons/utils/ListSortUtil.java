...
/**
 * @author shiJian 在数据库中查出来的列表中，往往需要对不同的字段重新排序。 一般的做法都是使用排序的字段，重新到数据库中查询。
...
public class ListSortUtil {
	private static final Logger LOG = LoggerFactory.getLogger(ListSortUtil.class);
