...
@Component
@ServerEndpoint(value = "/websocket/mesgshow/{clientId}/{userId}")
public class WebSocketServlet {
	...
	public void setBusLineService(BusLineService busLineService) {
		WebSocketServlet.busLineService = busLineService;
	}
	 ...
	 */
	private static Map<String, WebSocketServlet> webSocketMap = Collections
			.synchronizedMap(new HashMap<String, WebSocketServlet>());
	...
	public WebSocketServlet(Session session, String clientId, String userId) {
		super();
	...
	public void onOpen(@PathParam(value = "clientId") String clientId, @PathParam(value = "userId") String userId,
		...
		try {
			...
			webSocketMap.put(clientId, new WebSocketServlet(session, clientId, userId));
			addOnlineCount();
	...
	public static Map<String, WebSocketServlet> getWebSocketMap() {
		return webSocketMap;
	}

	public static void setWebSocketMap(Map<String, WebSocketServlet> webSocketMap) {
		WebSocketServlet.webSocketMap = webSocketMap;
	}
