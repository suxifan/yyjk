...
public class QueryCondition extends Condition {
	...
	public String toString() {
		...
		builder.append("orgId=").append(this.getOrgId()).append("&lineId=").append(this.getLineId()).append("&type=")
				.append(this.getType()).append("&busNumber=").append(this.getBusNumber());
