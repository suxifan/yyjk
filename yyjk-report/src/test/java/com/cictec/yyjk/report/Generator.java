...
public class Generator {
	...
	private static GeneratorEntity getGeneratorEntity() {
		...
		entity.setBase_package("com.cictec.yyjk.report");// 生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
		...
		entity.setJdbcUrl("jdbc:postgresql://117.34.118.30:25432/datacenter");
	...
	public static void main(String[] args) {
		...
		GeneratorCode.genCodeByCustomModelName("temp_pl_t_warn", "TempPltwarn");
